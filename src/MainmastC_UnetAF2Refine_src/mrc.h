...
typedef struct{
 ...
 float LogAA[20],LogSS[3],LogATOM[6];
 float plDDT;
 int AAtype;
} NODE;
...
bool NormalizeMrc(MRC *,float);
bool CopyMrc(MRC *,MRC *);
bool AddProbToMrc(PTBL *,MRC *,float,float,float,int);
bool AssignProbToNode(PTBL *,POINTS *,GRAPH *,MRC *);
bool AssignProbToNodeSimple(PTBL *,GRAPH *,MRC *);
bool AssignUnetProbToNode(MRC *,MRC *,GRAPH *);
